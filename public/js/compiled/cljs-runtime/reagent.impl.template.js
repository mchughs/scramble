...
var G__36656 = o;
(G__36656[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36887__delegate = function (args){
...
return G__36887__delegate.call(this,args);};
...
return G__36887__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36694){
...
var props = map__36695__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36695__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36703){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36704__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__36712){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36713__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36713__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__36724 = jsprops;
(G__36724["defaultValue"] = value);

(G__36724["onChange"] = (function (p1__36709_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__36709_SHARP_);
}));
...
var vec__36738 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36738,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36738,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36738,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36952 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36952 == null)){
} else {
var key_36954 = temp__5739__auto___36952;
(jsprops["key"] = key_36954);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__36763){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36764__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__36766 = reagent.impl.template.__GT_NativeWrapper();
(G__36766["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__36773 = wrapped;
(G__36773["syntheticInput"] = true);

return G__36773;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__36774 = wrapped__$1;
(G__36774["syntheticOnChange"] = on_change);

return G__36774;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__36778 = wrapped__$2;
(G__36778["syntheticOnUpdate"] = on_update);
...
args__4742__auto__.push((arguments[i__4737__auto___36974]));
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36827){
var G__36828 = cljs.core.first(seq36827);
var seq36827__$1 = cljs.core.next(seq36827);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36828,seq36827__$1);
}));
...
break;
default:
var G__36989 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__36989;
continue;
...
var n__4613__auto___36996 = a.length;
var i_36997 = (0);
while(true){
if((i_36997 < n__4613__auto___36996)){
(a[i_36997] = reagent.impl.template.as_element((a[i_36997])));

var G__37007 = (i_36997 + (1));
i_36997 = G__37007;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___37008 = a.length;
var i_37009 = (0);
while(true){
if((i_37009 < n__4613__auto___37008)){
var val_37010 = (a[i_37009]);
if(((cljs.core.vector_QMARK_(val_37010)) && ((reagent.impl.template.key_from_vec(val_37010) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37009] = reagent.impl.template.as_element(val_37010));

var G__37011 = (i_37009 + (1));
i_37009 = G__37011;
continue;
} else {
}
...
var G__36875 = (cljs.core.count(argv) - first_child);
switch (G__36875) {
case (0):
