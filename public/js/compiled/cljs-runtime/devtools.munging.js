...
var o28022 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28022["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28023 = temp__5733__auto____$1;
return (o28023["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27155__auto__ = f;
return (o__27155__auto__["toString"]).call(o__27155__auto__);
} else {
return "";
}
}catch (e28031){var _ = e28031;
return "";
}});
...
try{var o__27155__auto___28289 = t;
(o__27155__auto___28289["cljs$lang$ctorPrWriter"]).call(o__27155__auto___28289,t,writer);
}catch (e28034){var __28290 = e28034;
}
...
var char_code = (function (){var o__27155__auto__ = (new String(char$));
return (o__27155__auto__["charCodeAt"]).call(o__27155__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27155__auto__ = String;
return (o__27155__auto__["fromCharCode"]).call(o__27155__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28041 = num_code;
switch (G__28041) {
case (1):
return (185);
...
var o__27155__auto__ = String;
return (o__27155__auto__["fromCharCode"]).call(o__27155__auto__,superscript_code);
});
/**
...
}catch (e28074){var _e__27194__auto__ = e28074;
return false;
}})())){
...
var vec__28075 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28075,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28089 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28089["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28090 = temp__5733__auto____$1;
return (o28090["nameToPath"]);
} else {
return null;
}
} else {
...
while(true){
if((i__4737__auto___28318 < len__4736__auto___28316)){
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28095,(0),null);
...
var G__28320 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28321 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28320;
remaining_tokens = G__28321;
continue;
}
}
break;
...
var vec__28103 = cljs.core.split_with((function (p1__28102_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28102_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28103,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28103,(1),null);
...
var vec__28119 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28119,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28119,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28324 = cljs.core.rest(remaining_tokens);
var G__28325 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28324;
name_tokens = G__28325;
continue;
} else {
...
var vec__28134 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28134,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28134,(1),null);
var vec__28137 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28137,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28137,(1),null);
var vec__28140 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28140,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28140,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28140,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28140,(3),null);
...
var vec__28152 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(5),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28158,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28158,(1),null);
var vec__28161 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28161,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28161,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28165 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28165) : devtools.munging.parse_fn_info_deep.call(null,G__28165));
})()));
}
} else {
return fn_info;
...
var G__28372 = (arity + (1));
var G__28373 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28189){
var vec__28193 = p__28189;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28193,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28193,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28204_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28204_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28205_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28205_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28211){
var vec__28212 = p__28211;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28212,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28209){
var G__28210 = cljs.core.first(seq28209);
var seq28209__$1 = cljs.core.next(seq28209);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28210,seq28209__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28235 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28235,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28235,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28235,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28235,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28235,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28235,(5),null);
...
var o__27155__auto__ = f;
return (o__27155__auto__["getBasis"]).call(o__27155__auto__);
});
/**
...
}catch (e28240){var _e__27194__auto__ = e28240;
...
var G__28428 = (obj[cljs.core.first(path)]);
var G__28429 = cljs.core.rest(path);
obj = G__28428;
path = G__28429;
continue;
} else {
...
var _STAR_ = (function (accum,p__28252){
var vec__28253 = p__28252;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28253,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28253,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28266){
var vec__28267 = p__28266;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28267,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28267,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28267,(2),null);
...
var post_process = (function (p__28274){
var vec__28276 = p__28274;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28276,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28276,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28270_SHARP_){
return (obj[cljs.core.first(p1__28270_SHARP_)]);
}),sorted_matches);
