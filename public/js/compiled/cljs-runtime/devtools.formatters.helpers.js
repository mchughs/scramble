...
var G__28382 = devtools.prefs.pref(v);
v = G__28382;
continue;
} else {
return v;
...
}catch (e28303){var _e__27194__auto__ = e28303;
return false;
}})();
...
}catch (e28308){var _e__27194__auto__ = e28308;
return false;
}})();
...
}catch (e28314){var _e__27194__auto__ = e28314;
return false;
}}
}
});
...
var vec__28332 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28332,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28332,(1),null);
...
return cljs.core.some((function (p1__28350_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28350_SHARP_);
}),template);
});
