...
var G__28608 = (i__4737__auto___28606 + (1));
i__4737__auto___28606 = G__28608;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28421){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28422,G__28423,seq28421__$2);
}));
...
var map__28524 = opts;
var map__28524__$1 = (((((!((map__28524 == null))))?(((((map__28524.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28524.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28524):map__28524);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28524__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28538){var _e__27194__auto__ = e28538;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28540){var _e__27194__auto__ = e28540;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28556 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28557 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28557);

try{var map__28559 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28559__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28556);
}});
...
var temp__5733__auto___28627 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___28627)){
var managed_print_level_28628 = temp__5733__auto___28627;
var _STAR_print_level_STAR__orig_val__28568_28629 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28569_28630 = managed_print_level_28628;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28569_28630);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28563_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28563_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28568_28629);
}} else {
job_fn();
}
