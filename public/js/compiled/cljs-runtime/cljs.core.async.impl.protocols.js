...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30964 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30964(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30965 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30965(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30966 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30966(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30973 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30973(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30974 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30974(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30975 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30975(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30982 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30982(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30983 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30983(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30998 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30998(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31003 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31003(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31004 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31004(b);
}
});
